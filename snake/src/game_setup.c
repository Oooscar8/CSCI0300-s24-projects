...
enum board_init_status initialize_game(int** cells_p, size_t* width_p,
    ...
    snake_p->snake_position_list = NULL;
    ...
    if (board_rep != NULL) {
        ...
        insert_first(&snake_p->snake_position_list, &initial_snake_position,
                     sizeof(int));
    }
...
void initialize(char alpha, int num, int row, int column, int** cells_p,
    ...
    if (alpha == 'S') {
        ...
        insert_first(&(*snake_p)->snake_position_list, &snake_position,
                     sizeof(int));
    }
}